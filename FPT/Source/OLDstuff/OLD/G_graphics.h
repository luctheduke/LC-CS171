...
extern int (* G_change_pen_dimensions) (int w, int h) ;
...
extern int (* G_line) (int ixs, int iys, int ixe, int iye) ;
...
extern int (* G_polygon) (double *x, double *y, int numpts) ;
// provided as an alternative for passing arrays of doubles
// return 1 always
// capable of drawing a polygon with thick outline


extern int (* G_triangle) (int x0, int y0, int x1, int y1, int x2, int y2) ; 
// return value it inherits from G_polygon
// capable of drawing a triangle with thick outline


extern int (* G_rectangle) (int xleft, int yleft, int width, int height) ; 
// return value it inherits from G_polygon
...
extern int (* G_single_pixel_horizontal_line) (int x0, int x1, int y) ;
// return 1 always
// This is not guaranteed to be safe
...
extern int (* G_fill_circle) (int a, int b, int r) ;
// always return 1


extern int (* G_unclipped_fill_polygon) (int *xx, int *yy, int n) ;
...
extern int (* G_fill_polygon) (double *xx, double *yy, int n) ;
// provided as an alternative for passing arrays of doubles
// return 0 if size needs to be truncated (unusual), 
// or if clipping is used,  otherwise return 1
// This is SAFE
...
extern int (* G_fill_triangle) (int x0, int y0, int x1, int y1, int x2, int y2) ; 
// return value it inherits from G_fill_polygon


extern int (* G_fill_rectangle) (int xleft, int yleft, int width, int height) ;
// return value it inherits from G_fill_polygon
...
extern int (* G_string_pixel_width) (void *s) ;
// return the length in pixles of the string s

extern int (* G_draw_string) (void *one_line_of_text, int LLx, int LLy) ;
...
extern int (* G_save_image_to_file) (void *filename) ;
// return 1 if successful, else 0

extern int (* G_get_image_from_file) (void *filename, int x, int y) ;
// return 1 if successful, else 0



extern int (* G_get_pixel) (int x, int y) ;
// return the 32 bit pixel value...assumes x,y are legal
// i.e. it is NOT safe

extern int (* G_get_pixel_SAFE) (int x, int y, int pixel[1]) ;
// return 1 if successful, else 0
