...
//static char         *TheFont = "lucidasans-italic-24" ;
//static char         *TheFont = "lucidasans-bold-24" ;
//static char         *TheFont = "lucidasans-24" ;
//static char         *TheFont = "-adobe-courier-medium-r-normal--34-240-100-100-m-200-iso8859-1" ;
//static char         *TheFont = "12x24romankana" ;
...
// the above is the one you've historically used


//static char         *TheFont = "-b&h-lucidabright-medium-r-normal--34-240-100-100-p-193-iso8859-1" ;
// i like the above for a bigger font
...
// request[1] = desired_height
{
    ...
    if ((ww == The_Win_width) && (hh == The_Win_height)) { return 1 ; }
    ...
    ///////////////////////////////////////////////////////////////////
        ...
        if ((ww > The_Pix_width)|| (hh > The_Pix_height)) {
	...
	} // end if ((ww > The_Pix_width)|| (hh > The_Pix_height)) 
...
// what you actually got is 'returned' in the actual[2] array
{
  ...
  XResizeWindow(TheDisplay, TheWindow, The_Win_width, The_Win_height) ;
  actual[0] = The_Win_width ;
  actual[1] = The_Win_height ;
