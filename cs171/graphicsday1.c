...
double x[10], y[10] ;
double numpoints, q, x1, y0, x1, y1 ;
double p[2] ;
...
G_rgb(1, 0, 0) ; //red
G_point(200, 380) ; //plot point

G_rgb(0, 1, 0); //green
G_line(0, 0, 399, 399);

G_rgb(0, 0, 1); //blue
lowleftx = 200 ; lowlefty = 50; width = 01 ; height = 30 ;
...
G_fill_triangle(10,100, 40,100, 50,150) ;
...
q= G_wait_key() ; //pause again bef ore exit

G_save_image_to_file ("t01c.wxd") ;
